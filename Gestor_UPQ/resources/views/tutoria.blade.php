            ...
            <section class="dashboard">
                <div class="top">
                    ...
                    <div class="tab-content" id="subir">
                        ...
                        <form action="{{ route('upload.pdf') }}" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            @csrf
                            <table>
                                <tr>
                                    <td>Convocatorias:</td>
                                ...
                                <tr>
                                    <td>Evidencia:</td>
                                    <td>
                                        <input type="file" name="evidencia" id="evidencia" onchange="enableSubmit()">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <button type="submit" id="submitButton" disabled>Subir Archivo</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
                    ...
                    <!-- Script JavaScript para habilitar el botón de envío -->
                    <script>
                ...
                <div class="welcome-section jumbotron">
                    <h1>Bienvenido a la Sección de Tutoria </h1>
                    <p>Explora tus archivos y gestiona la Tutoria de manera eficiente.</p>
                </div>
